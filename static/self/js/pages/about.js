    ...
    <div class="ui grid">
      <div class="sixteen wide column">
        <div class="card shadow">
          <h1 class="ui center aligned header"><span><i class="ui icon info circle colored"></i> 关于洛谷保存站 - 追忆版</span></h1>
        </div>
      </div>
    </div>
    <div class="ui grid">
      <div class="sixteen wide column">
        <div class="card shadow outline">
          ...
          <p>本站点是洛谷保存站追忆版，将旧版的前端界面连接上新版保存站的API，可以在新后端上回忆旧版本的使用体验。因为新版保存站采用了前后端分离的模式，且提供了全面的API，因此得以实现本项目。</p>
